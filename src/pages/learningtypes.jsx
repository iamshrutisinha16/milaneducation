        ...
        <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} className="card shadow-lg border-0">
          ...
          <form className="p-4" onSubmit={handleSubmit}>
            ...
            <div className="form-check my-3">
              ...
              <label className="form-check-label">I agree to share information with College Milan</label>
            </div>

            <div className="text-center mt-4">
              <motion.button whileHover={{ scale: 1.07 }} whileTap={{ scale: 0.95 }} type="submit" className="btn px-5 py-2 fw-bold" style={{ background: orange, color: "#fff" }}>
                Submit Enquiry
              </motion.button>
            </div>
          </form>
